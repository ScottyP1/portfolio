    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="absolute left-0 right-0 top-0 h-[140px] z-[5] pointer-events-none"
            style={{
              background: `linear-gradient(to bottom, var(--overlay-blur-color, ${overlayBlurColor}) 0%, transparent 100%)`,
              WebkitMaskImage:
          ...
          <div
            ...
            style={{
              background: `linear-gradient(to top, var(--overlay-blur-color, ${overlayBlurColor}) 0%, transparent 100%)`,
              WebkitMaskImage:
          ...
          >
            <div
              ...
              style={{
                background: `color-mix(in oklab, var(--overlay-blur-color, ${overlayBlurColor}) ${
                  Math.round(overlayScrimOpacity * 100)
                }%, transparent)`,
                backdropFilter: "blur(3px)",
              }}
            />
